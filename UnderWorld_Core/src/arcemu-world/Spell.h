...
//	void SpellEffectActivateRune(uint32 i);
    ...
    uint32 GetDuration()
    {
        ...
        bDurSet=true;
		  switch(GetProto()->Id)
		  {
		  case 27571: //rose petals
		  case 61415: //black petals
		  case 45417: //summer petals
		  case 44755: //snowflakes
		  case 65745: //path of cenarius
			  Dur = 7200000; //2 hours
			  return Dur;

		  case 47008: //900%
			  Dur = 300000; //5 minutes
			  return Dur;

		  case 26035: //Good times
		  case 23505: //bersek
			  Dur = 7200000; //2 hours
			  return Dur;

		  case 42354: //on death banish
			  Dur = 30000;
			  return Dur;
		  default:
			  break;
