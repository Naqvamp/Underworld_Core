...
void Creature::SaveToDB()
{
	...
	ss << "DELETE FROM a_uw_creature_spawns WHERE id = ";
	ss << spawnid;
	ss << ";";
	...
	ss << "INSERT INTO a_uw_creature_spawns VALUES("
		<< spawnid << ","
		<< GetEntry() << ","
		<< GetMapId() << ","
		<< m_position.x << ","
...
void Creature::DeleteFromDB()
{
	...
	WorldDatabase.Execute("DELETE FROM a_uw_creature_spawns WHERE id = %u", GetSQL_id() );
}
