...
void LootMgr::LoadLoot()
{
	...
	LoadLootTables("a_uw_loot_creatures",&CreatureLoot);
	LoadLootTables("loot_gameobjects",&GOLoot);
	LoadLootTables("a_uw_loot_gameobjects",&GOLoot);
	LoadLootTables("loot_skinning",&SkinningLoot);
	LoadLootTables("a_uw_loot_skinning",&SkinningLoot);
	LoadLootTables("loot_fishing",&FishingLoot);
	LoadLootTables("a_uw_loot_fishing",&FishingLoot);
	LoadLootTables("loot_items", &ItemLoot);
	LoadLootTables("a_uw_loot_items", &ItemLoot);
	LoadLootTables("loot_pickpocketing", &PickpocketingLoot);
	LoadLootTables("a_uw_loot_pickpocketing", &PickpocketingLoot);
	is_loading = false;
}
