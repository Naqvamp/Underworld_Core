...
public:
   ...
   void OnDied(Unit * mKiller)
   {
	      if (mKiller->IsPlayer())
      {
         QuestLogEntry *qle = ((Player*)mKiller)->GetQuestLogForEntry(11230);
         if( qle != NULL )
         {
...
public:
   ...
   void OnDied(Unit * mKiller)
   {
      if (mKiller->IsPlayer())
      {
         QuestLogEntry *qle = ((Player*)mKiller)->GetQuestLogForEntry(11397);
         if( qle != NULL )
         {
            if( qle->GetMobCount( 0 ) < qle->GetQuest()->required_mobcount[ 0 ] )
            {
...
public:
   ...
   void OnDied(Unit * mKiller)
   {
      if (mKiller->IsPlayer())
      {
         QuestLogEntry *qle = ((Player*)mKiller)->GetQuestLogForEntry(11283);
         if( qle != NULL )
         {
            if( qle->GetMobCount( 0 ) < qle->GetQuest()->required_mobcount[ 0 ] )
            {
...
{
	GossipScript * Plague = (GossipScript*) new Plaguethis_Gossip(); // thx  Dzjhenghiz
