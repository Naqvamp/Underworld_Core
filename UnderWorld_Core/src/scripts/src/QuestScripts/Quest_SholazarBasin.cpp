...
void SetupSholazarBasin( ScriptMgr * mgr )
{
	...
	GossipScript * gossip1 = (GossipScript*) new HemetTasteTest();
	mgr->register_gossip_script(HEMET, gossip1);
	GossipScript * gossip2 = (GossipScript*) new HadriusTasteTest();
	mgr->register_gossip_script(HADRIUS, gossip2);
	GossipScript * gossip3 = (GossipScript*) new TamaraTasteTest();
