...
LuaSpellEntry luaSpellVars[] = {
	...
	{"spell_can_crit", 2, offsetof(SpellEntry, spell_can_crit)},
	...
	int ResetVar(lua_State * L, Spell * sp)
	{
		...
		for (uint32 itr = 0; luaSpellVars[itr].name != NULL; itr++)
		{
			...
			if (strcmp(l.name, var) == 0) //they entered a correct var name
			{
				...
				{
				case 0:
					*(int*)((char*)sp->GetProto() + l.offset + subindex) = *(int*)((char*)sp->m_spellInfo + l.offset + subindex);
					lua_pushboolean(L, 1);
					break;
				case 1:
					*(char**)((char*)sp->GetProto() + l.offset + subindex) = *(char**)((char*)sp->m_spellInfo + l.offset + subindex);
					lua_pushboolean(L, 1);
					break;
				case 2:
					*(bool*)((char*)sp->GetProto() + l.offset + subindex) = *(bool*)((char*)sp->m_spellInfo + l.offset + subindex);
					lua_pushboolean(L, 1);
					break;
				case 3:
					*(float*)((char*)sp->GetProto() + l.offset + subindex) = *(float*)((char*)sp->m_spellInfo + l.offset + subindex);
					lua_pushboolean(L, 1);
					break;
				}
				return 1;
